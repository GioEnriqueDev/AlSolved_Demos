                    ...
                    >
                        ...
                        <div className="text-center mb-10">
                            ...
                            <motion.p
                                ...
                                className="text-orange-500 font-black tracking-[0.3em] uppercase text-[9px] bg-orange-500/10 py-2 px-6 rounded-full inline-block border border-orange-500/20 mb-4 animate-pulse"
                            >
                                PROGETTO DEMO • NON UN PRODOTTO FINALE
                            </motion.p>
                            <br />
                            <motion.p
                                initial={{ opacity: 0 }}
                                ...
                                className="text-slate-500 font-bold tracking-widest uppercase text-[8px]"
                            >
                                Exclusive Digital Network Simulation
                            </motion.p>
                        </div>
