      ...
      <div className="container mx-auto px-6 py-6 relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center items-center max-w-5xl mx-auto w-full mb-24 relative pointer-events-none text-center">
          ...
          >
            ...
            >
              Case Study <br />
              <span className="text-primary text-[5rem] md:text-[8rem]">AlSolved.</span>
            </motion.h1>
            ...
            >
              Esplora la nostra collezione di <span className="font-bold text-slate-800 italic uppercase underline decoration-primary decoration-4 underline-offset-4">Progetti Demo</span>. 
              Soluzioni tecnologiche su misura, dalla protezione digitale alla logistica intelligente.
            </motion.p>
        ...
        >
          <CompactCard
            ...
            description="Caso studio: Back to Black. Gestione social media premium con contenuti video ad alto impatto e visual identity dedicata."
            icon={<Rocket className="w-6 h-6" />}
            href="/social-management"
            accent="bg-orange-500"
            label="DEMO: SOCIAL STRATEGY"
          />
          <CompactCard
            title="Secure Digital Reader"
            description="Protezione 'Highlander' per magazine digitali: accesso unico, watermark dinamico e sistemi anti-leak avanzati."
          ...
          <CompactCard
            ...
            description="Automazione logistica per espositori: validazione real-time hotel/staff e generazione pass digitale istantanea."
          ...
          />
          <CompactCard
            title="Marketing Landing Demo"
            description="L'esperienza Fermento Birra online. Una landing page ad alte prestazioni progettata per convertire e fidelizzare."
            icon={<Sparkles className="w-6 h-6" />}
            href="https://alsolved.com/alsolvedfermento"
            accent="bg-emerald-500"
            label="DEMO: BRAND EXPERIENCE"
            isExternal={true}
          />
          <CompactCard
            title="Admin Command Center"
            description="Controllo totale dell'infrastruttura: monitoraggio minacce in tempo reale e analisi trend in tempo reale."
            icon={<BookOpen className="w-6 h-6" />}
            href="/admin"
            accent="bg-slate-800"
            label="DEMO: ADMIN CENTER"
          />
        </motion.div>
...
function CompactCard({ title, description, icon, href, accent, label, isExternal }: {
  title: string;
  description: string;
