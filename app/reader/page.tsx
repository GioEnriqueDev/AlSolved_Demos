    ...
    return (
        ...
        >
            <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] flex flex-col items-center gap-2">
              <div className="px-6 py-2 bg-orange-600/20 backdrop-blur-xl border border-orange-500/30 rounded-full text-[10px] font-black tracking-[0.3em] text-orange-500 uppercase">
                PROGETTO DEMO • SOLO A SCOPO ILLUSTRATIVO
              </div>
            </div>
            <MagazineViewer>
                {PAGES_DATA.map((page) => (
